...
#pagebreak()
= production écrite d'un argument <argumentecrite>
...
#pagebreak()
= structurer son propos <structurerpropos>

== Introduire le sujet

- Nous vivons dans un monde où...
- De nos jours, un thème brûlant de l'actualité est...
- Cette question est depuis longtemps au cœur du débat...
- Presque chaque jour, on trouve des articles qui...
- De nos jours, il est presque impossible de consulter les médias sans lire que...
- Aujourd'hui, tout le monde s'accorde à dire que...
- Tour le monde s'accorde à penser que... est l'un des principaux maux de notre société.
- Un problème dont il est souvent question dans notre société est celui de...

#pagebreak()
== Présenter la première partie

- Il est bien connu que... a apporté des avantages tels que...
- Réfléchissons d'abord aux raisons pour lesquelles...
- Tout d'abord, examinons...
- Commençons par observer...
- En premier lieu, il convient de considérer avec attention le thème de...
- Il serait utile de se pencher sur la question de...
...
- En revanche, quelques-uns soutiennent que ceci a causé beaucoup de problèmes tels que...
- Après avoir étudié..., considerons maintenant...
- Il faut maintenant en venir à...
- Il convient à présent d'analyser...
- Il faut dès lors s'interroger sur...
- Considérons dès à présent le...
- La dernière constatation qui s'impose c'est que...
- Il est nécessaire d'aborder également le sujet~/ la question de...
- Tournons-nous vers la question de...
- Il serait intéressant de voir aussi si...
- Il est raisonnable de panser que...
- Un deuxième point de vue consiste à dire que...
- Il faut néanmoins reconnaître~/ considérer que...
- Nous devons nous demander également si...
- D'un autre côté, on remarque que...
- Il se peut aussi que le contraire soit vrai dans une certaine mesure et...
...
- Par exemple, ...
- Prenons le cas de...
- Un exemple qui met en lumière la question de... est le suivant~: ...
- Pour illustrer ceci, ...
- Pour donner un exemple, ...
- Nous citerons par exemple...
- Un exemple nous suffira, celui de...
- On peut prendre l'exemple de...
- Pour illustrer ce fait à l'aide d'un exemple~: ...

== Souligner un argument

- Il est clair~/ évident que...
- Il faut insister sur le fair que...
- N'oublions pas que...

== Conclure (résumé des idées)
...
- D'après ce qui précède, il semble~/ semblerait que...
- Toutes choses considérées, on peut déduire que...
- La conclusion inéluctable à laquelle on aboutit est que...
- On ne peut aboutir qu'à une seule conclusion logique~: ...
- Il découle~/ résulte de tout cela que...
- Ainsi, il apparaît que...
- Les choses dont il a été question ci-dessus prouvent~/ démontrent que...
...
#grammarbox()[
  #table(
    columns: (1fr, 2fr),
    stroke: none,
    [une action depend sur un autre], [*à condition que* + _subjonctif_\ *à condition de* + _infinitif_],
...
#text(size: 6pt)[
  #table(
    ...
    [se souvenir], [de qqch], [de qqn], [avoir fait qqch], [],
    [téléphoner], [], [à qqn], [], [],
